 ...
 * CSI 2110
 *
 * DBScan1 is the main class of the program. Here, you can
...
public class DBScan1 {
    ...
    private NearestNeighboursKD NN; 
    ...
    public DBScan1(List<Point3D> DB){
        this.DB = DB;
