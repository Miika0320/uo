...
function init() {
    ...
    var cylinderGeometry = new THREE.CylinderGeometry(1, 1, .25, 64);
    var material = new THREE.MeshBasicMaterial({ color: 0xffff00 });
    cylinderGroup.add(new THREE.Mesh(cylinderGeometry, material));
    cylinderGroup.position.set(-5, 0, 0);
    scene.add(cylinderGroup);

	// dodecahedron of radius 1
    // position the dodecahedron - right rear

    var dodecahedronGroup = new THREE.Group();
    var dodecahedronGeometry = new THREE.DodecahedronGeometry(1);
    var dodecamaterial = new THREE.MeshBasicMaterial({ color: 0xffff00 });
    dodecahedronGroup.add(new THREE.Mesh(dodecahedronGeometry, dodecamaterial));
    dodecahedronGroup.position.set(5, 0, 0);
