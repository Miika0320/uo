...
public class SearchList extends ArrayAdapter<Account>{
    private Activity context;
    List<Account> accounts;

    public SearchList(Activity context, List<Account> accounts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textViewPrice.setText(String.valueOf(account.getAccountAddress()));
        return listViewItem;
    }
}
